...
[arabic]
. Navigate to https://github.com/metadatastician/f117a-stealth-glider/security/advisories/new[Report a Vulnerability]
...
* *GitHub Security Advisories*: Published at https://github.com/metadatastician/f117a-stealth-glider/security/advisories[Security Advisories]
...
* https://github.com/metadatastician/f117a-stealth-glider/security/advisories[Security Advisories]
...
|===
|Purpose |Contact
|*Security issues* |https://github.com/metadatastician/f117a-stealth-glider/security/advisories/new[Report via GitHub] or j.d.a.jewell@open.ac.uk
|*General questions* |https://github.com/metadatastician/f117a-stealth-glider/discussions[GitHub Discussions]
...
_Thank you for helping keep F117A Stealth Glider and its users safe._ 🛡️
