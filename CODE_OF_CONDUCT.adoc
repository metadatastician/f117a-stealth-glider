...
. *Email* j.d.a.jewell@open.ac.uk with subject line "Appeal: ++[++Original Report ID++]++"
...
* Open a https://github.com/metadatastician/f117a-stealth-glider/discussions[Discussion] (for general questions)
