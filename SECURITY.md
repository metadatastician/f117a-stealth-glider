...
1. Navigate to [Report a Vulnerability](https://github.com/metadatastician/f117a-stealth-glider/security/advisories/new)
...
- This repository (`metadatastician/f117a-stealth-glider`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/metadatastician/f117a-stealth-glider/security/advisories)
...
When using F117A Stealth Glider, we recommend:
...
- [Security Advisories](https://github.com/metadatastician/f117a-stealth-glider/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/metadatastician/f117a-stealth-glider/security/advisories/new) or j.d.a.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/metadatastician/f117a-stealth-glider/discussions) |
...
*Thank you for helping keep F117A Stealth Glider and its users safe.* 🛡️
