...
Upstream: `metadatastician/f19-stealth-glider` @ `4af642af490f455c19ede724fe20efabf04e95cd`
...
link:./src/verify-kernel-parity.mjs[`src/verify-kernel-parity.mjs`] (claim C1).

[[srckernelenginemjs--verbatim]]
== `src/kernel/engine.mjs` — VERBATIM

[cols=",",]
|===
|upstream blob |`e9a26afe7736baa7faab35b582e01e30951b91b1`
...
[[srcmissionmjs--declared-fork]]
== `src/mission.mjs` — DECLARED FORK

[cols=",",]
|===
|upstream blob |`62591769529d73f06fd99e24a177231569d1262f`
...
[arabic]
. title line — `F117A Stealth Glider` for `F19 Stealth Glider`
. import path — `./kernel/engine.mjs` for `./engine.mjs`
...
counterfactual shadow world, i.e. what you _disturb_. This repository adds
*radar* — what _sees_ you.
...
into the substrate and its cells _are_ substrate cells, so "painted" has no
